...
//
// This example uses the pre-C++11 threading provided by RHEL 6.
//
...
//   threads
//
// We define sender and receiver classes with simple, thread-safe
// blocking send() and receive() functions.
//
// These classes are also privately proton::message_handler
// instances. They use the thread-safe proton::work_queue and standard
// C++ synchronization (std::mutex etc.) to pass messages between user
// and proton::container threads.
//
